...
<!--    Code to Auto refresh page-->
    <script>
        $(function() {
            ...
            if (timer == 8) {
                $.post("notices.php", {notice: test}, function (data) {
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="active"><a href="notices.php"><i class="glyphicon glyphicon-th"></i> Notices</a></li>
                        ...
                        <h2 class="panel-title text-center"><i class="fa fa-newspaper-o"></i><b
                            ...
                            <form method="post" action="#" class=" form-group pull-left"
                                ...
                                <Select class="form-control col-sm-10"
                                    ...
                                    <option name="education">Education Notices</option>
                            ...
                            <a class="pull-right glyphicon glyphicon-option-horizontal" href="notices.php"
...
<strong>Warning!</strong>No data found in the database</div> </tr>";
                                    }
                                            ...
                                            <div class="modal-body">
                                                ...
                                                if (mysqli_num_rows($description_query) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($description_query)) {
                                                        ...
                                                        $image=$row['document'];
                                                        echo"<h4 style='border-bottom: 1px solid #000;background-color: rgba(255,255,255,0.08);'><b>$title</b></h4>";
                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            function generate_calendar($year, $month, $days = array(), $day_name_length = 3, $month_href = NULL, $first_day = 0, $pn = array())
                            {
                                ...
                                $calendar = "<div class=\"mini_calendar\">\n<table style='width:350px ;border-bottom:5px solid #5bc0de;'>" . "\n" .
