...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="col-sm-3 col-sm-offset-4 frame">
            <h3>Get Realtime Help| Notice Board Bot</h3>

            <div class="col-sm-12" style="height: 450px;border-style: solid;overflow:scroll;overflow-x: hidden;font-family: Arial, Helvetica, sans-serif;">
                I am mr Notice bot
            ...
            <p class="well" style="font-size: 12px;color: #2b2b2b;">
                ...
                if(isset($_POST['send_comments'])) {
                    ...
                    if ($comment == "Hello" | $comment=="hello") {
                        echo "Hello too  $name , How are you?";
                    } else if ($comment == "Hey" | $comment=="hey") {
                        echo "Hey too $name, How are you?";
                    }else if($comment=="i am fine" | $comment=="I am fine"){
                        echo"Ok.How do you want me to help you?";
                    }
                    else if($comment=="How do i view notices"| $comment=="how do i view notices" | $comment=="HOW DO I VIEW NOTICES"){
                     echo"Just click on the following link <a href='notices.php' class='btn btn-primary'>Notices</a> to view the notices";
                    }
                    else if($comment=="How do i view upload notices" | $comment=="how do i view upload notices"| $comment="HOW DO I VIEW UPLOAD NOTICES"){
                        echo"Just click on the following link <a href='upload.php' class='btn btn-primary'>Upload Notices</a> to upload the notices";

                    }
                    else if($comment=="How do i  view notice gallery" | $comment=="how do i view notice gallery" | $comment=="HOW DO I VIEW NOTICE GALLERY"){
