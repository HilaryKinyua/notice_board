...
<div class="header-w3l">
    <h1>Notice Board App | <strong>Lecturer</strong></h1>
</div>
<!--//header-->
<!--main-->
<div class="main-content-agile">
    <div class="sub-main-w3">
        ...
        <?php include("lecturer_login_to_db.php") ?>
        <form action="#" method="post">
            ...
            <div class="icon1 form-group">
                <div class="input-group">
                    ...
                    <input placeholder="Username" class="form-control" name="email" id="email" type="email" required=""
                           autocomplete="off">
                </div>
            </div>
